...
/**
 * Расширение "Региональные настройки".
 * 
 * Настройка часового пояса и страны по умолчанию.
 * 
 * Расширение принадлежит модулю "Конфигурация".
 * 
 * @author Anton Tivonenko <anton.tivonenko@gmail.com>
 * @package Gm\Backend\Config\TimeZone
 * @since 1.0
 */
class Extension extends \Gm\Panel\Extension\Extension
{
     ...
     * {@inheritdoc}
     */
    public string $id = 'gm.be.config.timezone';
